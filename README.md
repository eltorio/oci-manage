...
*   [5. Cluster deployment](#5-déploiement-du-cluster)
    ...
    *   [5.3. Name resolution](#53-résolution-de-nom)
    *   [5.4. Workers](#54-workers)
    *   [5.5. Clearing the cluster and reinstalling the cluster](#55-effacement-du-cluster-et-résinstallation-du-cluster)
        *   [5.5.1. Erasure](#551-effacement)
        *   [5.5.2. Resettlement](#552-réinstallation)
    *   [5.6. Persistent storage](#56-stockage-persistant)
        *   [5.6.1. Longhorn](#561-longhorn)
        *   [5.6.2. OpenEBS/jiva](#562-openebsjiva)
    *   [5.7. Certificate Manager](#57-gestionnaire-de-certificat)
    *   [5.8. Openness to the outside world](#58-ouverture-sur-le-monde-extérieur)
    *   [5.9. Access to dashboards](#59-accès-aux-tableaux-de-bord)
    *   [5.10. Grafana](#510-grafana)
    *   [5.11. Local container registry](#511-registre-local-de-container)
        *   [5.11.1. Create a specific name resolution:](#5111-créer-une-résolution-de-nom-spécifique)
        *   [5.11.2. To add an image:](#5112-pour-ajouter-une-image)
        *   [5.11.3. To uninstall the local registry:](#5113-pour-désinstaller-le-registre-local)
        *   [5.11.4. User Interface](#5114-interface-utilisateur)
    *   [5.12. Letsencrypt](#512-letsencrypt)
        *   [5.12.1. Oracle OCI DNS01](#5121-oracle-oci-dns01)
            *   [5.12.1.1. Installation](#51211-installation)
            *   [5.12.1.2. Use](#51212-utilisation)
            *   [5.12.1.3. Uninstallation](#51213-désinstallation)
        *   [5.12.2. Azure DNS](#5122-azure-dns)
            *   [5.12.2.1. Install the Azure CLI](#51221-installation-de-azure-cli)
            *   [5.12.2.2. Installation](#51222-installation)
            *   [5.12.2.3. Use](#51223-utilisation)
            *   [5.12.2.4. Uninstalling](#51224-désinstallation)
        *   [5.12.3. Automatic deployment of CNAME Cloudflare](#5123-deploiement-automatique-de-cname-cloudflare)
            *   [5.12.3.1. Installation](#51231-installation)
            *   [5.12.3.2. Example of use](#51232-exemple-dutilisation)
            *   [5.12.3.3. Uninstallation](#51233-désinstallation)
    *   [5.13. Helm-Dashboard](#513-helm-dashboard)
    *   [5.14. Wireguard](#514-wireguard)
        *   [5.14.1. Initialization](#5141-initialisation)
        *   [5.14.2. Adding a node](#5142-ajout-dun-nœud)
        *   [5.14.3. View Nodes](#5143-voir-les-nœuds)
        *   [5.14.4. Deploy Nodes](#5144-déployer-les-nœuds)
    *   [5.15. File `README.md` multilingual](#515-fichier-readmemd-multilingue)
    *   [5.16. Bird on the control-plane](#516-bird-sur-le-control-plane)
...
By default the CRI (container runtime interface) is defined with Mirantis cri-docker, to use the internal plugin of containerd set the DOCKER_RUNTIME variable to containerd
